...
class LinkedList {
  ...
  add(data){
    ...
    // Si la lista ya tiene un nodo o mas nodos.
    while(current.next){
  ...
  remove(){
    ...
    // Si la lista tiene un unico nodo.
  ...
  search(valor){
    ...
    // // If the value is a number or string
